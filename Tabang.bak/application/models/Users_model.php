...
class Users_model extends CI_Model
{
    ...
    {
                $query = $this->db->query('SELECT tbl_emergencyreport.addressDesc,tbl_emergencyreport.Ereport_ID,tbl_emergencyType.EmegencyType,tbl_Resident.*,tbl_emergencyreport.date,
    ...
    {
        $query = $this->db->query('SELECT tbl_emergencyreport.addressDesc,tbl_emergencyType.EmegencyType,tbl_Resident.ContactNumber,tbl_ForwardReport.Status_incident,tbl_ForwardReport.Freport_ID,
