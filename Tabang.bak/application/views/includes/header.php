...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url(); ?>assets/dist/modal.css">
...
">
        ...
        <a class="nav-link" href="<?php echo base_url(); ?>index.php/User/adminhome">
        
          <i class="far fa-bell fa-2x"></i>
          <span id="notifNumber" class="badge badge-danger navbar-badge" style="font-size: 1.5vw;">
          0
          </span>
        </a>
