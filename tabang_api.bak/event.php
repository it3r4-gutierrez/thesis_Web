...
//                       var_dump($row);
            ...
            $sql = "INSERT INTO `tbl_emergencyreport`(`longitude`, `latitude`, `resident_id`,`addressDesc`,`EtypeID`)  VALUES ('".$_POST["longitude"]."','".$_POST["latitude"]."','".$_POST["resident_ID"]."','".$_POST["addressDesc"]."','".$_POST["EtypeID"]."')";
